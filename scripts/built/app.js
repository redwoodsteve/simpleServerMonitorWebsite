...
var serverAddr = "https://" + window.location.host;
var gamemodeIcons = {
...
function updatePage() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, getPerformanceInfo()];
                case 1:
                    data = _a.sent();
                    ...
                    data.players.forEach(function (value, key) {
                        var element = document.createElement("li");
                        var div = document.createElement("div");
                        var p = document.createElement("p");
                        var gsvg = document.getElementById("templateIcon").cloneNode(true);
                        var osvg = document.getElementById("templateIcon").cloneNode(true);
                        gsvg.innerHTML = gamemodeIcons[value.get("gamemode")];
                        osvg.innerHTML = opIcons[value.get("op")];
                        p.innerText = value.get("name");
